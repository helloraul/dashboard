      ...
      <nav class="top-bar" data-topbar>
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
              ...
              <li class=""><a target="_blank" href="/dashboard/phpinfo.php">Register </a></li>
			  <li class=""><a href="/phpmyadmin/">Admin</a></li>
			  <li class=""><a href="/dashboard/login.html">Alumni Login</a></li>
          </ul>
        </section>
      </nav>
    </div>
...
<div class="row">
   <h2>Add user</h2>
<form action="adduser_submit1.php" method="post">
<fieldset>
<p>
